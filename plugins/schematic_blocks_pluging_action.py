...
class SchematicBlocksPluging(pcbnew.ActionPlugin):
    def defaults(self):
        self.name = "SchematicBlocks"
        self.category = "A descriptive category name"
        self.description = "A description of the plugin and what it does"
        self.show_toolbar_button = True # Optional, defaults to False
        self.icon_file_name = os.path.join(os.path.dirname(__file__), 'icon.png') # Optional, defaults to ""
